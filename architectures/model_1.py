...
arch = [
    ...
    to_Pool("pool1","(3,0,0)","(conv3-east)",caption="MaxPool", height=52, depth=52, width=2),
    to_connection("conv3", "pool1"),
    to_Conv("flatten", 1, 1, offset="(3,0,0)", to="(pool1-east)", caption="flatten", height=2, depth=64, width=2 ),
