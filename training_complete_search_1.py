...
complete_search(0,parameters,parameters_values,chosen,images,labels,create_model_1,train_model_1,test_model_1,"./results/complete_search/1-1.csv")

chosen = {}
images, labels = get_dataset_1("./dataset_normalized_1")
complete_search(0,parameters,parameters_values,chosen,images,labels,create_model_1,train_model_1,test_model_1,"./results/complete_search/1-2.csv")

chosen = {}
images, labels = get_dataset_2("./dataset_normalized_1")
complete_search(0,parameters,parameters_values,chosen,images,labels,create_model_1,train_model_1,test_model_1,"./results/complete_search/1-3.csv")

# Model 2: convolutional 1D neural netwrok with binary classification

chosen = {}
images, labels = get_dataset_0("./dataset_normalized_2")
complete_search(0,parameters,parameters_values,chosen,images,labels,create_model_2,train_model_2,test_model_2,"./results/complete_search/2-1.csv")

chosen = {}
images, labels = get_dataset_1("./dataset_normalized_2")
complete_search(0,parameters,parameters_values,chosen,images,labels,create_model_2,train_model_2,test_model_2,"./results/complete_search/2-2.csv")

chosen = {}
images, labels = get_dataset_2("./dataset_normalized_2")
complete_search(0,parameters,parameters_values,chosen,images,labels,create_model_2,train_model_2,test_model_2,"./results/complete_search/2-3.csv")
